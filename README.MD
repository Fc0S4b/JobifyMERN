...
Proyecto de práctica con ReactJS, MongoDB y NodeExpress del curso de John Smilga en [udemy](https://www.udemy.com/share/105HjC3@L5Jo9BMWLcxqB2n9_ChDHoXtj5Qe1LZHE-B91DHzFGSB5qNOAFIZ4HSv0yjzvDP3eQ==/).
...
- no olvides usar app.use(express.json()) en server.js para obtener el body que envías en postman
...
- impórtalo por encima de todas las importaciones, si no no tendrás respuesta en postman y se crasheará la app
...
- rm -rf .git
- para windows users rm -r -fo .git
- git init
- git add .
